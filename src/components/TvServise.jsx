    ...
    <section className="main-service">
      ...
      <div className="tv-service">
        ...
        <div className="right-side">
          ...
          <h5>
            পতেঙ্গা অনলাইন লিমিটেডের সাথে সংযুক্ত হন যা বিশ্বকে সংযুক্ত করার
            জন্য আপনার প্রয়োজনীয় প্রতিটি প্রযুক্তি সরবরাহ করতে পারে।
          </h5>
          <div className="exp-content">
            ...
            <p className="exp-des">
              পতেঙ্গা অনলাইন ইন্টারনেট চট্টগ্রাম ১৪ নম্বর বিমানবন্দর জুড়ে
              দ্রুততম ব্রডব্যান্ড ইন্টারনেট এবং নেটওয়ার্ক সলিউশন প্রদান করছে,
              সকলের জন্য নির্ভরযোগ্য।
            </p>
          </div>
